...
function CulturalServiceItem({ item }: { item: typeof culturalServices[0] }) {
  return (
    <View style={styles.serviceItem}>
      <View style={[styles.serviceIcon, { backgroundColor: Colors.light.gold + '15' }]}>
        <Ionicons name={item.icon as any} size={22} color={Colors.light.gold} />
      </View>
...
function OtherServiceItem({ item }: { item: typeof otherServices[0] }) {
  return (
    <View style={styles.otherItem}>
      <View style={[styles.otherIcon, { backgroundColor: Colors.light.primary + '10' }]}>
      ...
      <View style={styles.modalOverlay}>
        <View style={[styles.modalContent, { paddingBottom: insets.bottom + 20 }]}>
          ...
          <TextInput
            ...
            placeholder="Ej: Boda, cumpleanos, evento corporativo"
            placeholderTextColor={Colors.light.textTertiary}
          />
