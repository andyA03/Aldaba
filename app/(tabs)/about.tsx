...
function ValueCard({ value, index }: { value: string; index: number }) {
  ...
  return (
    <View style={styles.valueCard}>
      <View style={[styles.valueIcon, { backgroundColor: Colors.light.gold + '15' }]}>
        <Ionicons name={icons[index % icons.length]} size={20} color={Colors.light.gold} />
      </View>
    ...
    <View style={styles.communityItem}>
      ...
      <View style={styles.communityContent}>
        <View style={styles.communityHeader}>
          <View style={[styles.communityIcon, { backgroundColor: Colors.light.secondary + '12' }]}>
            <Ionicons name={item.icon as any} size={18} color={Colors.light.secondary} />
          </View>
...
function ContactItem({
  ...
  return (
    ...
    >
      <View style={[styles.contactIcon, { backgroundColor: Colors.light.primary + '10' }]}>
    ...
    >
      ...
      >
        ...
        <Text style={styles.headerSubtitle}>
          Nuestra historia, valores y compromiso con Trinidad
        </Text>
      </LinearGradient>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.footer}>
          ...
          <Text style={styles.footerCopy}>
            Aldaba - Todos los derechos reservados
          </Text>
        </View>
      </View>
    </ScrollView>
